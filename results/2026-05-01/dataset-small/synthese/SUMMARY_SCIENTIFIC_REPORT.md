...
<table style="width:100%; border-collapse:collapse; margin:15px 0; font-family:Arial,sans-serif; font-size:11pt;">
  ...
  <tr style="background-color:#f9f9f9;">
    ...
    <td style="padding:8px; border:1px solid #ccc;">356.55 s</td>
    <td style="padding:8px; border:1px solid #ccc;">334.92 s</td>
    <td style="padding:8px; border:1px solid #ccc;">**6.1%**</td>
  </tr>
  <tr style="background-color:#ffffff;">
    <td style="padding:8px; border:1px solid #ccc;">**Total Energy Consumption**</td>
    <td style="padding:8px; border:1px solid #ccc;">3575.73 Wh</td>
    <td style="padding:8px; border:1px solid #ccc;">3353.23 Wh</td>
    <td style="padding:8px; border:1px solid #ccc;">**6.2%**</td>
  </tr>
  <tr style="background-color:#f9f9f9;">
    <td style="padding:8px; border:1px solid #ccc;">**SLA Breach Severity**</td>
    <td style="padding:8px; border:1px solid #ccc;">1.89x</td>
    <td style="padding:8px; border:1px solid #ccc;">1.78x</td>
    <td style="padding:8px; border:1px solid #ccc;">**6.1%**</td>
  </tr>
  <tr style="background-color:#ffffff;">
    <td style="padding:8px; border:1px solid #ccc;">**Network Congestion Rate**</td>
    <td style="padding:8px; border:1px solid #ccc;">64.7%</td>
    <td style="padding:8px; border:1px solid #ccc;">64.7%</td>
...
*Figure 1: Modèle topologique du Datacenter — Dataset Small (Congested Asymmetric)*
...
<table style="width:100%; border-collapse:collapse; margin:15px 0; font-family:Arial,sans-serif; font-size:11pt;">
  ...
  <tr style="background-color:#f9f9f9;">
    <td style="padding:8px; border:1px solid #ccc;">**Host (h0-h5)**</td>
...
<table style="width:100%; border-collapse:collapse; margin:15px 0; font-family:Arial,sans-serif; font-size:11pt;">
  ...
  <tr style="background-color:#f9f9f9;">
    <td style="padding:8px; border:1px solid #ccc;">**Path A (Best)**</td>
    <td style="padding:8px; border:1px solid #ccc;">300</td>
    <td style="padding:8px; border:1px solid #ccc;">0.05</td>
    <td style="padding:8px; border:1px solid #ccc;">500</td>
  </tr>
  <tr style="background-color:#ffffff;">
    <td style="padding:8px; border:1px solid #ccc;">**Path B (Slow)**</td>
...
<table style="width:100%; border-collapse:collapse; margin:15px 0; font-family:Arial,sans-serif; font-size:11pt;">
  ...
  <tr style="background-color:#f9f9f9;">
    ...
    <td style="padding:8px; border:1px solid #ccc;">187.05%</td>
    <td style="padding:8px; border:1px solid #ccc;">2187.50%</td>
    <td style="padding:8px; border:1px solid #ccc;">Dépend du VM Placement</td>
  </tr>
  <tr style="background-color:#ffffff;">
    <td style="padding:8px; border:1px solid #ccc;">**RAM Load**</td>
    <td style="padding:8px; border:1px solid #ccc;">508.64%</td>
