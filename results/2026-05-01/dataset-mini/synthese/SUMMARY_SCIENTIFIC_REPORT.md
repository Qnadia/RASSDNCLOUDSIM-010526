...
<table style="width:100%; border-collapse:collapse; margin:15px 0; font-family:Arial,sans-serif; font-size:11pt;">
  ...
  <tr style="background-color:#f9f9f9;">
    ...
    <td style="padding:8px; border:1px solid #ccc;">36.11 s</td>
    <td style="padding:8px; border:1px solid #ccc;">29.23 s</td>
    <td style="padding:8px; border:1px solid #ccc;">**19.1%**</td>
  </tr>
  <tr style="background-color:#ffffff;">
    <td style="padding:8px; border:1px solid #ccc;">**Total Energy Consumption**</td>
    <td style="padding:8px; border:1px solid #ccc;">159.72 Wh</td>
    <td style="padding:8px; border:1px solid #ccc;">153.50 Wh</td>
    <td style="padding:8px; border:1px solid #ccc;">**3.9%**</td>
  </tr>
  <tr style="background-color:#f9f9f9;">
    <td style="padding:8px; border:1px solid #ccc;">**SLA Breach Severity**</td>
    <td style="padding:8px; border:1px solid #ccc;">5.35x</td>
    <td style="padding:8px; border:1px solid #ccc;">4.33x</td>
    <td style="padding:8px; border:1px solid #ccc;">**19.1%**</td>
  </tr>
  <tr style="background-color:#ffffff;">
    <td style="padding:8px; border:1px solid #ccc;">**Network Congestion Rate**</td>
    <td style="padding:8px; border:1px solid #ccc;">95.8%</td>
    <td style="padding:8px; border:1px solid #ccc;">95.8%</td>
