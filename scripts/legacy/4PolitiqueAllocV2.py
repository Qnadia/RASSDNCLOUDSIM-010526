...
standard_policies = ["LFF", "FCFS", "Spread", "Binpack", "LWFF", "LWFFVD", "MipLFF", "MipMFF", "RR", "CombMFF", "CombLFF"]
sjf_policies = ["SJFLFF", "SJFFCFS", "SJFSpread", "SJFBinpack", "SJFLWFF", "SJFLWFFVD", "SJFMipLFF", "SJFMipMFF", "SJFRR", "SJFCombMFF", "SJFCombLFF"]
...
def plot_cpu_usage(resource_usage, policy):
    ...
    color = policy_colors.get(policy, "black")  # Get color from the palette
    plt.bar(resource_usage["host"], resource_usage["CPU"], color=color, edgecolor="black",width=0.3)
