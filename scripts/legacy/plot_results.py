...
def main():
    ...
    parser.add_argument("--expdir",  default="experiment1",  help="Dossier des résultats")
    ...
    print(f"\n📊 Génération des figures depuis : {args.expdir}")
    print(f"   Format : .{args.format} (vectoriel) + .png 600 DPI\n")
