...
public class CloudSimTagsSDN {
	...
	public static final int TRANSMISSION_ACTIVITY = SDN_BASE + 9;// MAJ Nadia
	...
	public static final int WORKLOAD_SUBMIT = SDN_BASE + 22;
	public static final int WORKLOAD_SUBMIT_ACK = SDN_BASE + 23;
	public static final int WORKLOAD_COMPLETED = SDN_BASE + 24;
	public static final int WORKLOAD_FAILED = SDN_BASE + 25;
	public static final int WORKLOAD_BATCH_SUBMIT = SDN_BASE + 29;
	public static final int STOP_MONITORING = SDN_BASE + 26;
	public static final int VM_UPDATE = SDN_BASE + 28;

	public static final int MONITOR_UPDATE_UTILIZATION = SDN_BASE + 27;
