 ...
 * Pe to a VM, and
 * doesn't allow sharing of PEs. If there is no free PEs to the VM, allocation
 * fails. Free PEs are
...
public class VmSchedulerTimeSharedOverSubscriptionDynamicVM extends VmSchedulerTimeSharedOverSubscription
	...
	@Override
	public void setHost(org.cloudbus.cloudsim.sdn.physicalcomponents.Node host) {
		if (this.powerMonitor != null) {
			this.powerMonitor.setEntityId(host.getAddress());
		}
	}
	 ...
	 * this.utilizationHistories.add(new
	 ...
	 * this.utilizationHistories.add(new PowerUtilizationHistoryEntry(time,
	 * usingMips/ getTotalMips()));
	 * }
	 * 
