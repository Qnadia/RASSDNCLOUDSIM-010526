...
public class SimpleExampleSelectLinkBandwidthV2 extends SimpleExample {
	...
	public static void main(String[] args) {
		...
		try { 
			...
			if(!SimpleExampleSelectLinkBandwidthV2.logEnabled) 
				Log.disable();
	...
	public static void submitWorkloads(SDNBroker broker, String sortingAlgorithm, String[] workloadFiles) {
		try (PrintWriter logWriter = new PrintWriter(new FileWriter("D:/Workspace/CLOUDSIMSDN/submitWorkloads_log.txt", true))) {
			...
			Map<Integer, Long> flowIdToBandwidthMap = NetworkOperatingSystem.getFlowIdToBandwidthMap(); // Récupérer la bande passante
