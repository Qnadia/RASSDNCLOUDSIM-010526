...
public class StartExperimentSFCEdge {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		try {
			...
			NetworkOperatingSystem_Old nos = null;
			...
			Map<NetworkOperatingSystem_Old, SDNDatacenter> dcs = createPhysicalTopology(physicalTopologyFile, ls, vmAllocationFac,
...
//					hostSelectionPolicy, vmMigrationPolicy);
	...
	public static Map<NetworkOperatingSystem_Old, SDNDatacenter> createPhysicalTopology(String physicalTopologyFile, 
			LinkSelectionPolicy ls, VmAllocationPolicyFactory vmAllocationFac,
			HostSelectionPolicy hostSelectionPolicy,
			VmMigrationPolicy vmMigrationPolicy) {
		HashMap<NetworkOperatingSystem_Old, SDNDatacenter> dcs = new HashMap<NetworkOperatingSystem_Old, SDNDatacenter>();
		// This funciton creates Datacenters and NOS inside the data cetner.
		Map<String, NetworkOperatingSystem_Old> dcNameNOS = PhysicalTopologyParser.loadPhysicalTopologyMultiDC(physicalTopologyFile);
		
		for(String dcName:dcNameNOS.keySet()) {
			NetworkOperatingSystem_Old nos = dcNameNOS.get(dcName);
			nos.setLinkSelectionPolicy(ls);
	...
	protected static SDNDatacenter createSDNDatacenter(String name, 
			NetworkOperatingSystem_Old snos, 
