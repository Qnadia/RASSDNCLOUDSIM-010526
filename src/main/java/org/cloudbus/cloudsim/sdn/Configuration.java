...
public class Configuration {
    // MAJ Nadia : auto-détection du répertoire de travail
    // Si lancé depuis le dossier parent (cloudsimsdn090525), cherche le
    // sous-dossier cloudsimsdn/
    public static String workingDirectory = detectWorkingDir();
    public static String experimentName = "experiment1/";

    private static String detectWorkingDir() {
        if (new java.io.File("./dataset-energy").exists())
            return "./";
        if (new java.io.File("./cloudsimsdn/dataset-energy").exists())
            return "./cloudsimsdn/";
        // Fallback : chemin absolu du répertoire courant
        System.err.println("⚠ dataset-energy introuvable depuis : " + System.getProperty("user.dir"));
        return "./";
    }

    /* MAJ Nadia */
    public static String allocationPolicyName = "UNDEFINED";

    // Paramètres de monitoring pour l'expérience d'overbooking
    public static final double monitoringTimeInterval = 10; // en secondes
    public static final double overbookingTimeWindowInterval = monitoringTimeInterval;
    public static final double overbookingTimeWindowNumPoints = 10; // Nombre de points à suivre
    public static final double migrationTimeInterval = overbookingTimeWindowInterval * overbookingTimeWindowNumPoints;
    ...
    public static final double DECIDE_SLA_VIOLATION_GRACE_ERROR = 1.30; // Période de grâce SLA (30%)

    public static final double OVERBOOKING_RATIO_UTIL_PORTION = (OVERBOOKING_RATIO_MAX - OVERBOOKING_RATIO_MIN) * 0.2;
    public static final double OVERLOAD_HOST_PERCENTILE_THRESHOLD = 0.3; // Seuil de surcharge pour les hôtes

    public static double CPU_REQUIRED_MIPS_PER_WORKLOAD_PERCENT = 1.0; // 20% de CPU par workload

    public static final double HOST_ACTIVE_AVERAGE_UTIL_THRESHOLD = 0.1;

    // Configuration de Service Function Chaining (SFC)
    ...
    public static final double TIME_OUT = Double.POSITIVE_INFINITY; // IT22 fix : désactivé pour large dataset
                                                                    // (workloads > 20000s simulées)

    public static boolean ENABLE_SFC = true;
    public static boolean SFC_LATENCY_AWARE_ENABLE = false;
    ...
    public static final double NETWORK_PACKET_SIZE_MULTIPLY = 1; // Pas de mise à l'échelle
}
...
// //*/
// //////////////////////////// Default value
// public static final double CPU_SIZE_MULTIPLY = 1; // Multiply all the CPU
// size for scale. Default =1 (No amplify)
// public static final double NETWORK_PACKET_SIZE_MULTIPLY = 1; // Multiply all
// the network packet size. Default =1 (No amplify)

// public static double monitoringTimeInterval = 5; // every 1800 seconds,
// polling utilization.

// public static final double overbookingTimeWindowInterval =
// monitoringTimeInterval; // Time interval between points
// public static final double overbookingTimeWindowNumPoints =
// 1;//Double.POSITIVE_INFINITY; // No migration. How many points to track
// // public static final double overbookingTimeWindowNumPoints = 10; // How
// many points to track

// public static double migrationTimeInterval =
// overbookingTimeWindowInterval*overbookingTimeWindowNumPoints; // every 1
// seconds, polling utilization.
...
// public static final double DECIDE_SLA_VIOLATION_GRACE_ERROR = 1.0; //
// Expected time + 5% is accepted as SLA provided

// public static final double OVERBOOKING_RATIO_UTIL_PORTION =
// (OVERBOOKING_RATIO_MAX - OVERBOOKING_RATIO_MIN)*0.2;
// public static final double OVERLOAD_HOST_PERCENTILE_THRESHOLD = 0.0; // If 5%
// of time is overloaded, host is overloaded

// public static final double CPU_REQUIRED_MIPS_PER_WORKLOAD_PERCENT =
// 1.0;//0.05; // 20% of CPU resource is required to process 1 workload
